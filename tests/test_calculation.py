...
@patch.object(Operation, 'floor')
def test_calculation_execute_parameterized(
    mock_floor, mock_modulus, mock_power, mock_division, mock_multiplication, mock_subtraction,  mock_addition, 
    ...
    elif calc_type == 'floor':
        mock_floor.return_value = expected_result
    ...
    if calc_type == 'add':
        ...
        mock_floor.assert_called_once_with(a, b)
...
@pytest.mark.parametrize("calc_type, a, b, expected_str", [
    ...
    ('modulus', 10.0, 5.0, "ModulusCalculation: 10.0 Modulus 5.0 = 0.0"),
    ('floor', 10.0, 3.0, "FloorCalculation: 10.0 Floor 3.0 = 3.0"),
])
@patch.object(Operation, 'addition', return_value=15.0)
@patch.object(Operation, 'subtraction', return_value=5.0)
@patch.object(Operation, 'multiplication', return_value=50.0)
...
@patch.object(Operation, 'floor', return_value=3.0)
def test_calculation_str_parameterized(
    mock_division, mock_multiplication, mock_subtraction, mock_addition, mock_power, mock_modulus, mock_floor,
